...
{
bool cdr_serialize(
  const franka_msgs::msg::CollisionIndicators &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
// functions for geometry_msgs::msg::WrenchStamped already declared above
...
{
bool cdr_serialize(
  const geometry_msgs::msg::InertiaStamped &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
// functions for geometry_msgs::msg::InertiaStamped already declared above
...
{
bool cdr_serialize(
  const geometry_msgs::msg::AccelStamped &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  franka_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.collision_indicators,
    cdr);
  // Member: measured_joint_state
  sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.measured_joint_state,
    cdr);
  // Member: desired_joint_state
  sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.desired_joint_state,
    cdr);
  // Member: measured_joint_motor_state
  sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.measured_joint_motor_state,
    cdr);
  // Member: ddq_d
  {
  ...
  sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.tau_ext_hat_filtered,
    cdr);
  // Member: elbow
  franka_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.elbow,
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.k_f_ext_hat_k,
    cdr);
  // Member: o_f_ext_hat_k
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.o_f_ext_hat_k,
    cdr);
  // Member: inertia_ee
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.inertia_ee,
    cdr);
  // Member: inertia_load
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.inertia_load,
    cdr);
  // Member: inertia_total
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.inertia_total,
    cdr);
  // Member: o_t_ee
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.o_t_ee,
  ...
  // Member: o_t_ee_d
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.o_t_ee_d,
    cdr);
  // Member: o_t_ee_c
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.o_t_ee_c,
    cdr);
  // Member: f_t_ee
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.f_t_ee,
  ...
  // Member: o_dp_ee_d
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.o_dp_ee_d,
    cdr);
  // Member: o_dp_ee_c
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.o_dp_ee_c,
    cdr);
  // Member: o_ddp_ee_c
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.o_ddp_ee_c,
    cdr);
  // Member: time
  ...
  size_t current_alignment)
{
  ...
  // Member: collision_indicators
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        franka_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CollisionIndicators(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: elbow
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        franka_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Elbow(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: inertia_ee
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        geometry_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_InertiaStamped(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: o_ddp_ee_c
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        geometry_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_AccelStamped(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
