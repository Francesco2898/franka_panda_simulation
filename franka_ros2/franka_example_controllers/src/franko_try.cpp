...
controller_interface::CallbackReturn MoveCatersianImpWithGripper::on_init()
{
  ...
  // target placing pose for IK (position + quaternion xyzw)
  declare_if_needed("placing_position", std::vector<double>{0.5, 0.0, 0.4});
  declare_if_needed("placing_orientation_xyzw", std::vector<double>{0.0, 0.0, 0.0, 1.0});
