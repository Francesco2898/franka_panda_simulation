...
static const _Debug_type_support_symbol_names_t _Debug_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, debug_msg, msg, Debug)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, debug_msg, msg, Debug)),
  }
};
...
{
  return &::debug_msg::msg::rosidl_typesupport_cpp::Debug_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, debug_msg, msg, Debug)() {
  return get_message_type_support_handle<debug_msg::msg::Debug>();
}
